 ...
 *
 * Travail à faire :
 *  - Écrire un fichier db.ml respectant cette interface db.mli.
 *  - Justifier vos choix par le biais des commentaires dans votre code
 * Remarques :
 * - Vous devez respecter *exactement* cette interface
 * - Votre code sera lié à un programme de test automatique pour une première partie de la note
 ...
 * - Si vous n'arrivez pas à implanter certaines fonctions ou méthodes, utilisez (failwith "not implemented").
 * À rendre :
 * - Votre fichier db.ml renommé en [numéro etudiant]_[nom].ml
 *   ou [numéro etudiant 2]_[nom 2]_[numéro etudiant 2]_[nom 2].ml si vous etes à deux
 * - Par email à benjamin.canou@lip6.fr, avec [LI332] dans le sujet
 * *)
